...
cl_id: null
display_name: Cancer Associated Fibroblast
parent_type: stromal_cell
references:
...
standard_name: cancer_associated_fibroblast
---

# Cancer Associated Fibroblast

> Activated fibroblasts in the tumor stroma that contribute to the tumor microenvironment architecture.

## Functional Characteristics

- **Stromal cells that remodel the extracellular matrix and support tumor growth** (ECM organization)
...
- Parent: [stromal_cell](stromal_cell.md)
