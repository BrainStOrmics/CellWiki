...
- C1QC+ TAMs
cl_id: null
display_name: C1Qc Positive Tumor Associated Macrophage
...
standard_name: c1qc_positive_tumor_associated_macrophage
evidence_tier: 4
source_count: 1
positive_markers:
- C1QC
...
# C1Qc Positive Tumor Associated Macrophage

> A macrophage subset characterized by C1QC expression, found enriched in tumor tissues.

## Markers

| Marker | Type | Evidence | Source |
|--------|------|----------|--------|
| C1QC | positive | scRNA-seq clustering | [exmaple_paper_2]() |

## Functional Characteristics

- **Enriched in tumor tissues** (complement activation)
