...
- LYVE1+ TAMs
cl_id: null
display_name: Lyve1 Positive Tumor Associated Macrophage
...
> A macrophage subset expressing LYVE1, often associated with tissue-resident or lymphatic-like phenotypes in tumors.

## Markers

| Marker | Type | Evidence | Source |
|--------|------|----------|--------|
| LYVE1 | positive | scRNA-seq clustering | [exmaple_paper_2]() |

## Functional Characteristics

- **Associated with lymphatic-like or tissue-resident macrophage functions** (lymphatic vessel development)
