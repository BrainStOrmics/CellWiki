...
standard_name: endothelial_cell
evidence_tier: 4
source_count: 1
positive_markers: []
negative_markers: []
...
> Cells lining blood vessels within the tumor microenvironment.

## Functional Characteristics

- **Vascular cells forming the tumor vasculature** (angiogenesis)
