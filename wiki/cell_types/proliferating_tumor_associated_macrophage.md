...
aliases:
- MKI67+ TAMs
- proliferating MKI67+ TAMs
cl_id: null
display_name: Proliferating Tumor Associated Macrophage
...
> A proliferating subset of tumor-associated macrophages identified by high MKI67 expression.

## Markers

| Marker | Type | Evidence | Source |
|--------|------|----------|--------|
| MKI67 | positive | scRNA-seq clustering | [exmaple_paper_2]() |

## Functional Characteristics

- **Actively proliferating macrophages within the tumor** (cell cycle)
