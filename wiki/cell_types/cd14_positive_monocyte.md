...
- classical monocyte
cl_id: CL:0001054
display_name: Cd14 Positive Monocyte
...
> A monocyte subset characterized by high CD14 expression, representing classical monocytes.

## Markers

| Marker | Type | Evidence | Source |
|--------|------|----------|--------|
| CD14 | positive | scRNA-seq clustering | [exmaple_paper_2]() |

## Functional Characteristics

- **Classical monocytes that serve as primary responders to inflammation** (inflammatory response)
