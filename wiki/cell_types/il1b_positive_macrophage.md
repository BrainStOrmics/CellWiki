...
- IL1B+ macrophage
cl_id: null
display_name: Il1B Positive Macrophage
...
> Macrophage subset producing IL-1β, implicated in driving pathogenic inflammation in pancreatic cancer.

## Markers

| Marker | Type | Evidence | Source |
|--------|------|----------|--------|
| IL1B | positive | Reference 70 title | [exmaple_paper_2]() |

## Functional Characteristics

- **Fuel pathogenic inflammation in the tumor microenvironment** (IL-1β inflammatory signaling)
