...
standard_name: m2_macrophage
---

# M2 Macrophage

> Alternatively activated macrophages used as a computational reference for polarization state inference.

## Functional Characteristics

- **Reference phenotype for macrophage polarization scoring** (anti-inflammatory and tissue repair signaling)
